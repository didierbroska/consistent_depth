...
<Configuration>
    ...
    <LogonCommand>
        <Command>C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe -executionpolicy unrestricted -command "start powershell {-noexit -nologo -file C:\\Users\\WDAGUtilityAccount\\Desktop\\$project_name\\installv2.ps1}"</Command>
    </LogonCommand>
</Configuration>
"@
...
# Main Section ================================================================
Write-Host "Run Windows Sandbox tester." -ForegroundColor Green
